...
export function StudentHistoryTimeline({ studentId, filters }: StudentHistoryTimelineProps) {
  const { history, loading, error, fetchStudentHistory } = useFlightHistoryStore();
    ...
    return (
      <Card>
        <div className="text-center py-8 text-gray-500">
          ...
          <p>No history available for this student</p>
        </div>
      </Card>
    );
  }
  ...
  return (
    <Card>
      <h3 className="text-lg font-semibold text-gray-900 mb-4">Student Flight History</h3>
